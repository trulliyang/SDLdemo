#ifndef _MOVIT_VIDEO_ON_VIDEO_OVERLAY_EFFECT_H
#define _MOVIT_VIDEO_ON_VIDEO_OVERLAY_EFFECT_H 1
...
class VideoOnVideoOverlayEffect : public Effect {
public:
	VideoOnVideoOverlayEffect();
	virtual std::string effect_type_id() const { return "VideoOnVideoOverlayEffect"; }
...
#endif // !defined(_MOVIT_VIDEO_ON_VIDEO_OVERLAY_EFFECT_H)
