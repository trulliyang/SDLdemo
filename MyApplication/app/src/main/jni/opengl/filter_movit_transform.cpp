...
#include <movit/transform_effect.h>
...
//                               mlt_properties_anim_get_double( properties, "out_color_alpha", position, length ) );
    ...
    *format = mlt_image_glsl;
    ...
    GlslManager::set_effect( MLT_FILTER_SERVICE( filter ), frame, new TransformEffect() );
...
mlt_filter filter_movit_transform_init( mlt_profile profile, mlt_service_type type,
