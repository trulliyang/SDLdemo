...
#include <movit/green_replacing_overlay_effect.h>
					  ...
					  int *width, int *height, int writable )
{
	...
	*format = mlt_image_glsl;
	...
	GlslManager::set_effect( service, a_frame, new GreenReplacingOverlayEffect );
...
extern "C"
mlt_transition transition_movit_green_replacing_overlay_init( mlt_profile profile,
