...
#include <movit/watermark_overlay_effect.h>
					  ...
					  int *width, int *height, int writable )
{
	...
	*format = mlt_image_glsl;
	...
	GlslManager::set_effect( service, a_frame, new WatermarkOverlayEffect );
...
extern "C"
mlt_transition transition_movit_watermark_overlay_init( mlt_profile profile, mlt_service_type type,
