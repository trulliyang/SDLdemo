//
// Created by shiyang1 on 2018/3/23.
//
...
#include <movit/rotation_effect.h>
...
//    mlt_properties_set_( properties, "_movit.parms.float.pixel",
//                               mlt_properties_anim_get_double( properties, "pixel", position, length ) );
    ...
    *format = mlt_image_glsl;
    ...
    GlslManager::set_effect( MLT_FILTER_SERVICE( filter ), frame, new RotationEffect() );
...
mlt_filter filter_movit_rotation_init( mlt_profile profile, mlt_service_type type,
